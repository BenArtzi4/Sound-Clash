...
- ~~**T-Deps · Audit the 4 `react-hooks/exhaustive-deps` disables.**~~ ✅ verified already satisfied 2026-07-10 — all 4 disables (`DisplayPage.tsx:115`, `SongExport.tsx:90`, `ManagerConsolePage.tsx:219,284`; backlog line numbers drifted during Phase 4) already carry a reason comment. No code change needed.
