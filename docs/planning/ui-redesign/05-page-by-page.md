...
- **Entrance.** Headline and rows stagger in (opacity + 12 px translate, 60 ms apart, 320 ms) once on first paint; not on back-navigation. _As of 2026-09-25 ([10-touch-and-route-motion.md](10-touch-and-route-motion.md)) it plays only when the page load begins on Home, and never on a return._
